...
class Formulario extends React.Component {
  constructor(props){
    super(props);
    this.state = {nome: '', linguagem: 'Javascript', tipo: 'programador', 
dedico: true, bio: ''}
  ...
  render() {
    return (
      ...
      <form onSubmit={this.handleSubmit}>
        <label>
          Nome: <input type="text" value={this.state.nome} onChange={this.changeName}></input><br/> 
        </label>
        <label>
          Linguagem Favorita: 
        ...
        <label>
          <input type="checkbox" checked={this.state.dedico} onChange={this.changeCheckbox}></input>Dedico 8h semanais aos estudos.
        </label> <br/>
        <label>
          Bio: 
